...
/*---------------------Comparable<T>---------------------*/
	...
	public int compareTo(Paivamaara a) {
		
		if (this.vuosi == a.vuosi) {
			
			if(this.kuukausi == a.kuukausi) {
		    
		    	if(this.paiva == a.paiva) {
		    		return 0;
		    		
		    	}else if(this.paiva > a.paiva) {
		    		return 1;
			...
			}else if(this.kuukausi > a.kuukausi) {
				return 1;
